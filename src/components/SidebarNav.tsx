...
import { Shirt, Layers, Calendar, Sparkles, Home, LogOut, Settings, Camera, Presentation, Smartphone, TrendingUp, ShoppingBag, ArrowLeftRight } from "lucide-react";
...
const navItems = [
  ...
  { label: "Style Compare", icon: ArrowLeftRight, href: "/compare" },
